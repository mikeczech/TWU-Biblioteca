...
public class TestConstants {
    ...
    public static final String MAIN_MENU_NOT_LOGGED_IN = "a) List Books\nd) List Movies\ne) Check-out Movie\nf) Return Movie\ng) Login\nj) List Accountabilities for Books\nk) Quit\n";
    public static final String MAIN_MENU_LOGGED_IN = "a) List Books\nb) Check-out Book\nc) Return Book\nd) List Movies\ne) Check-out Movie\nf) Return Movie\nh) Logout\ni) Show User Information\nj) List Accountabilities for Books\nk) Quit\n";
    public static final String WELCOME_MESSAGE = "Welcome to Biblioteca!\n\n";
    public static final String INITIAL_OUTPUT = WELCOME_MESSAGE + MAIN_MENU_NOT_LOGGED_IN + "\n" + SELECT_OPTION_MSG;
    ...
    public static final String SELECT_BOOKID_MSG = "Please select a book ID: ";
    public static final String MOVIE_THANK_YOU_MSG = "Thank you! Enjoy the movie\n";
    public static final String BOOK_THANK_YOU_MSG = "Thank you! Enjoy the book\n";
